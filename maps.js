...
function makeMap(idx){const m=maps[idx],obs=[],spawns=[],barr=[];if(m.id==='yard'){
 ...
 spawns.push({x:50,y:100},{x:60,y:1350},{x:650,y:50},{x:1320,y:70},{x:2040,y:100},{x:2050,y:1350});barr.push({x:735,y:320,w:24,h:130,hp:500,maxHp:500},{x:1270,y:950,w:24,h:130,hp:500,maxHp:500});
 } else if(m.id==='lab'){
 ...
 spawns.push({x:50,y:50},{x:1000,y:35},{x:1940,y:60},{x:1940,y:1330},{x:1000,y:1360},{x:60,y:1320});barr.push({x:790,y:300,w:24,h:140,hp:560,maxHp:560},{x:1260,y:920,w:24,h:140,hp:560,maxHp:560});
 ...
 spawns.push({x:45,y:70},{x:1120,y:35},{x:2190,y:80},{x:2190,y:1420},{x:1120,y:1460},{x:50,y:1410},{x:1120,y:760});barr.push({x:820,y:690,w:24,h:150,hp:620,maxHp:620},{x:1390,y:690,w:24,h:150,hp:620,maxHp:620},{x:1080,y:500,w:120,h:24,hp:620,maxHp:620});
 } else {
 ...
 spawns.push({x:35,y:40},{x:1030,y:35},{x:2010,y:45},{x:2010,y:1400},{x:1030,y:1410},{x:35,y:1400},{x:1030,y:710},{x:1540,y:680});barr.push({x:910,y:590,w:120,h:24,hp:700,maxHp:700},{x:1510,y:590,w:24,h:140,hp:700,maxHp:700},{x:610,y:980,w:24,h:140,hp:700,maxHp:700});
 }
